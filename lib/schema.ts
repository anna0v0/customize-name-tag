...
export const designSchema = z.object({
  ...
  icon: z.enum(["star","heart","flower","upload"]), iconScale: z.number().min(.7).max(1.5).optional(), avatarSelection: avatarSelectionSchema.optional(), iconDataUrl: z.string().optional(), iconAssetId: z.string().regex(/^[a-f0-9-]{36}$/).optional(),
