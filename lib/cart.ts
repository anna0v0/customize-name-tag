...
export function addToCart(design:CartDesign,quantity=1){const items=readCart();items.push({id:crypto.randomUUID(),design,quantity});writeCart(items);return items}
