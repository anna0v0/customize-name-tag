...
export default function OrganizerPage(){
 ...
 return <main className="organizer-page"><nav><a className="brand" href="/">THE <span className="brand-accent">ODDMENT</span> CLUB</a><div className="navlinks"><a href="/#products">PRODUCTS</a><a href="/about">ABOUT</a><a href="/order-status">ORDER STATUS</a></div></nav>
  <header className="organizer-hero"><p className="eyebrow">BUILT FOR BEYBLADE X</p><h1>Build your loadout.<br/><em>Battle ready.</em></h1><p className="organizer-hero-intro">Keep your Beyblade X collection organised in one dedicated setup. Separate Blades, Ratchets and Bits, keep your favourite combinations easy to find, and spend less time searching before the next launch.</p></header>
